                        ...
                        <form id="form-cadastrar-pessoa" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-3">
                                    ...
                                    <input class="form-control" type="text" name="documento" maxlength="20" placeholder="Informe o documento">
                                    <span class="error error-documento"></span>
                                </div>
                                <div class="col-md-4 mt-3">
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input class="form-control" type="text" name="numero" maxlength="20" placeholder="Informe o número">
                                ...
                                <div class="col-md-4 mt-3">
                                    ...
                                    <select class="form-select" name="uf" id="">
